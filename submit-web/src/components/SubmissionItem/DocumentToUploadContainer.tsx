...
import DocumentIcon from "./ManagementPlanSubmission/ManagementPlanProponentView/DocumentIcon";
...
import ProgressBar from "./ManagementPlanSubmission/ManagementPlanProponentView/ProgressBar";
